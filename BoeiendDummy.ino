...
/*
  ...
  */
  ...
  lora_stream[/*4 * NUM_TEMP_SENSORS */ 14] = 0x06;
  lora_stream[/*4 * NUM_TEMP_SENSORS */ 15] = 0x76;
  lora_stream[/*4 * NUM_TEMP_SENSORS */16] = 0x5f;
  lora_stream[/*4 * NUM_TEMP_SENSORS +*/17] = 0xF2;
  lora_stream[/*4 * NUM_TEMP_SENSORS +*/18] = 0x96;
  lora_stream[/*4 * NUM_TEMP_SENSORS +*/19] = 0x0a;
  
  lora_stream[/*4 * NUM_TEMP_SENSORS +*/20] = 0x00;
  lora_stream[/*4 * NUM_TEMP_SENSORS +*/21] = 0x03;
  lora_stream[/*4 * NUM_TEMP_SENSORS +*/22] = 0xE8;
